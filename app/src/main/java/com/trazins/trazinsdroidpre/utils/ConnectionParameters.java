...
public class ConnectionParameters {
    ...
    public static final int SET_URL_CONNECTION = 1;
    ...
    public static final String [] SOAP_ADDRESS = new String[]{
            ...
            /*6*/ "http://141.94.195.33:8066/Android/TrazinsDroidService.svc",      //Teruel
            /*7*/ "http://10.208.8.26:8040/Android/TrazinsDroidService.svc"         //Chihuahua
    };
